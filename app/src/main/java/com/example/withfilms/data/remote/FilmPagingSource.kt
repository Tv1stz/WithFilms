...
class FilmPagingSource @Inject constructor(
...
): PagingSource<Int, NetworkFilm>() {
    override fun getRefreshKey(state: PagingState<Int, NetworkFilm>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, NetworkFilm> {
